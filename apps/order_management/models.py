...
class CartModel(CustomModel):
    ...
    def __str__(self):
        return f"{self.user.name if self.user else ''} -- {self.hub.name if self.hub else ''} -- {self.order if self.order else ''}"
...
class CartItemModel(CustomModel):
    ...
    def __str__(self):
        return f"{self.item.title if self.item else ''} -- {self.cart.title if self.cart else ''}"
...
class VoucherModel(CustomModel):
    ...
    def __str__(self):
        return f"{self.title if self.title else ''} -- {self.voucher_type if self.voucher_type else ''} -- {self.city if self.city else ''}"
...
class OrderPaymentModel(CustomModel):
    ...
    def __str__(self):
        return f"{self.user.name if self.user else ''} -- {self.hub.name if self.hub else ''}"
